#############################################################################
# Makefile for building: startAQ
# Generated by qmake (3.1) (Qt 5.15.14)
# Project:  AqiumBuilds.pro
# Template: app
# Command: /usr/bin/qmake -o Makefile AqiumBuilds.pro
#############################################################################
...
TAR           = tar -cf
COMPRESS      = gzip -9f
DISTNAME      = startAQ1.0.0
DISTDIR = /home/gamer/Desktop/AquiumOS/.tmp/startAQ1.0.0
LINK          = g++
LFLAGS        = -Wl,-O1 -pipe -O2 -flto=8 -fno-fat-lto-objects -fuse-linker-plugin -fPIC
LIBS          = $(SUBLIBS) -lX11 -lXrandr -lXcursor -lGLEW /usr/lib/libQt5Widgets.so /usr/lib/libQt5Gui.so /usr/lib/libQt5Core.so -lGL -lpthread   
AR            = gcc-ar cqs
RANLIB        = 
SED           = sed
STRIP         = strip
...
SOURCES       = src/Window_Manager.cpp 
OBJECTS       = Window_Manager.o
DIST          = /usr/lib/qt/mkspecs/features/spec_pre.prf \
		...
		AqiumBuilds.pro  src/Window_Manager.cpp
QMAKE_TARGET  = startAQ
DESTDIR       = 
TARGET        = startAQ
...
Makefile: AqiumBuilds.pro /usr/lib/qt/mkspecs/linux-g++/qmake.conf /usr/lib/qt/mkspecs/features/spec_pre.prf \
		/usr/lib/qt/mkspecs/common/unix.conf \
		/usr/lib/qt/mkspecs/common/linux.conf \
		/usr/lib/qt/mkspecs/common/sanitize.conf \
		/usr/lib/qt/mkspecs/common/gcc-base.conf \
		...
		/usr/lib/qt/mkspecs/features/lex.prf \
		AqiumBuilds.pro
	$(QMAKE) -o Makefile AqiumBuilds.pro
...
distdir: FORCE
	...
	$(COPY_FILE) --parents src/Window_Manager.cpp $(DISTDIR)/
...
Window_Manager.o: src/Window_Manager.cpp 
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o Window_Manager.o src/Window_Manager.cpp
